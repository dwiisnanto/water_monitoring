...
<head>
    ...
    <title>Login Page - Water Monitoring</title>
    ...
    <div class="d-flex align-items-center justify-content-center ht-100v">
        ...
        <div class="overlay-body bg-black-7 d-flex align-items-center justify-content-center">
            <div class="login-wrapper wd-300 wd-xs-350 pd-25 pd-xs-40 rounded bg-black-6">
                <div class="signin-logo tx-center tx-18 tx-bold tx-white"><span class="tx-normal">[</span> Water <span class="tx-info">Monitoring</span> <span class="tx-normal">]</span></div>
                <div class="tx-white-5 tx-center mg-b-60">Water Quality System Information</div>
                ...
                <form method="POST" action="{{ route('login') }}">
                    ...
                    <div class="form-group">
                        ...
                        <a href="#" class="tx-info tx-12 d-block mg-t-10" style="font-italic">Email : user@user.com || Password: root</a>
                    </div><!-- form-group -->
